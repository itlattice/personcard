...
use iboxs\facade\Debug;
use iboxs\facade\Env;
use iboxs\facade\Hook;
...
if (!function_exists('app')) {
     ...
     * @return mixed|\iboxs\App
     */
    function app($name = 'iboxs\App', $args = [], $newInstance = false)
    {
...
if (!function_exists('download')) {
     ...
     * @return \iboxs\response\Download
     */
...
if (!function_exists('dump')) {
    ...
    {
        file_put_contents(LOG_PATH.'no.log',json_encode($var,JSON_UNESCAPED_UNICODE).PHP_EOL,FILE_APPEND);
...
if (!function_exists('trace')) {
     ...
     * @return array|void
     */
    function trace($log = '[iboxs]', $level = 'log')
    {
        if ('[iboxs]' === $log) {
            return Log::getLog();
        } else {
