...
use iboxs\exception\ClassNotFoundException;
...
class App extends Container
{
    ...
    {
        $this->iboxsPath = dirname(dirname(__DIR__)) . DIRECTORY_SEPARATOR;
        $this->path($appPath);
    }
    ...
    public function initialize()
    {
        ...
        // 加载惯例配置文件
        $this->config->set(include $this->iboxsPath . 'convention.php');

        // 设置路径环境变量
        $this->env->set([
            'iboxs_path'   => $this->iboxsPath,
    ...
    public function init($module = '')
    {
        ...
        if (is_file($path . 'init.php')) {
            ...
            if ('' == $module) {
                // 加载系统助手函数
                include $this->iboxsPath . 'helper.php';
            }
    ...
    protected function loadLangPack()
    {
        ...
        // 加载系统语言包
        $this->lang->load([
            $this->iboxsPath . 'lang' . DIRECTORY_SEPARATOR . $this->request->langset() . '.php',
