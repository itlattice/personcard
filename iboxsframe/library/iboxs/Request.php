...
class Request
{
    ...
    public function subDomain()
    {
        if (is_null($this->subDomain)) {
            ...
            if ($rootDomain) {
                // 配置域名根 例如 iboxsframe.cn 163.com.cn 如果是国家级域名 com.cn net.cn 之类的域名需要配置
     ...
     * 设置或者获取当前请求的调度信息
     * @access public
     * @param  \iboxs\route\Dispatch  $dispatch 调度信息
     * @return \iboxs\route\Dispatch
     */
