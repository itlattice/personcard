...
namespace iboxs\model\relation;
...
class BelongsToMany extends Relation
{
    ...
    {
        $class = $this->pivotName ?: '\\iboxs\\model\\Pivot';
        ...
        throw new Exception('pivot model must extends: \iboxs\model\Pivot');
    }
