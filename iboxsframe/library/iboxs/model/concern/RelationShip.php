...
use iboxs\model\relation\BelongsTo;
use iboxs\model\relation\BelongsToMany;
use iboxs\model\relation\HasMany;
use iboxs\model\relation\HasManyThrough;
use iboxs\model\relation\HasOne;
use iboxs\model\relation\MorphMany;
use iboxs\model\relation\MorphOne;
use iboxs\model\relation\MorphTo;
...
trait RelationShip
{
    ...
    protected function isRelationAttr($attr)
    {
        ...
        if (method_exists($this, $relation) && !method_exists('iboxs\Model', $relation)) {
            return $relation;
        }
