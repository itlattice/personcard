...
use iboxs\console\command\Help as HelpCommand;
...
use iboxs\console\output\driver\Buffer;
...
class Console
{
    ...
    private static $defaultCommands = [
        'help'              => "iboxs\\console\\command\\Help",
        'list'              => "iboxs\\console\\command\\Lists",
        'build'             => "iboxs\\console\\command\\Build",
        'clear'             => "iboxs\\console\\command\\Clear",
        'make:command'      => "iboxs\\console\\command\\make\\Command",
        'make:controller'   => "iboxs\\console\\command\\make\\Controller",
        'make:model'        => "iboxs\\console\\command\\make\\Model",
        'make:middleware'   => "iboxs\\console\\command\\make\\Middleware",
        'make:validate'     => "iboxs\\console\\command\\make\\Validate",
        'optimize:autoload' => "iboxs\\console\\command\\optimize\\Autoload",
        'optimize:config'   => "iboxs\\console\\command\\optimize\\Config",
        'optimize:schema'   => "iboxs\\console\\command\\optimize\\Schema",
        'optimize:route'    => "iboxs\\console\\command\\optimize\\Route",
        'run'               => "iboxs\\console\\command\\RunServer",
        'version'           => "iboxs\\console\\command\\Version",
        'route:list'        => "iboxs\\console\\command\\RouteList",
    ];
    ...
    public function addCommands(array $commands)
    {
        foreach ($commands as $key => $command) {
            if (is_subclass_of($command, "\\iboxs\\console\\Command")) {
                // 注册指令
