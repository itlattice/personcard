...
abstract class Connection
{
    ...
    public static function instance($config = [], $name = false)
    {
        ...
        if (true === $name || !isset(self::$instance[$name])) {
            ...
            self::$instance[$name] = Loader::factory($config['type'], '\\iboxs\\db\\connector\\', $config);
        }
    ...
    public function getBuilderClass()
    {
        ...
        return $this->getConfig('builder') ?: '\\iboxs\\db\\builder\\' . ucfirst($this->getConfig('type'));
    }
    ...
    protected function getCacheKey(Query $query, $value)
    {
        ...
        $prefix = 'iboxs:' . $this->getConfig('database') . '.';
