 ...
 * @see \iboxs\Log
 * @mixin \iboxs\Log
 * @method \iboxs\Log init(array $config = []) static 日志初始化
 * @method mixed getLog(string $type = '') static 获取日志信息
 * @method \iboxs\Log record(mixed $msg, string $type = 'info', array $context = []) static 记录日志信息
 * @method \iboxs\Log clear() static 清空日志信息
 * @method \iboxs\Log key(string $key) static 当前日志记录的授权key
 * @method \iboxs\Log close() static 关闭本次请求日志写入
