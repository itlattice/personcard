 ...
 * @see \iboxs\Cache
 * @mixin \iboxs\Cache
 * @method \iboxs\cache\Driver connect(array $options = [], mixed $name = false) static 连接缓存
 * @method \iboxs\cache\Driver init(array $options = []) static 初始化缓存
 * @method \iboxs\cache\Driver store(string $name = '') static 切换缓存类型
