...
abstract class Driver
{
     ...
     * @var array
     */
    protected static $serialize = ['serialize', 'unserialize', 'iboxs_serialize:', 16];
     ...
     * @return $this
     */
    public static function registerSerialize($serialize, $unserialize, $prefix = 'iboxs_serialize:')
    {
