<div id="iboxs_page_trace" style="position: fixed;bottom:0;right:0;font-size:14px;width:100%;z-index: 999999;color: #000;text-align:left;font-family:'微软雅黑';">
    <div id="iboxs_page_trace_tab" style="display: none;background:white;margin:0;height: 250px;">
        <div id="iboxs_page_trace_tab_tit" style="height:30px;padding: 6px 12px 0;border-bottom:1px solid #ececec;border-top:1px solid #ececec;font-size:16px">
        ...
        <div id="iboxs_page_trace_tab_cont" style="overflow:auto;height:212px;padding:0;line-height: 24px">
...
<script type="text/javascript">
    (function(){
        var tab_tit  = document.getElementById('iboxs_page_trace_tab_tit').getElementsByTagName('span');
        var tab_cont = document.getElementById('iboxs_page_trace_tab_cont').getElementsByTagName('div');
        var open     = document.getElementById('iboxs_page_trace_open');
        var close    = document.getElementById('iboxs_page_trace_close').children[0];
        var trace    = document.getElementById('iboxs_page_trace_tab');
        var cookie   = document.cookie.match(/iboxsframe_show_page_trace=(\d\|\d)/);
        ...
        open.onclick = function(){
            ...
            history[0] = 1;
            document.cookie = 'iboxsframe_show_page_trace='+history.join('|')
        }
